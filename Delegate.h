...
#define DECLARE_DELEGATE(retType, name, params, args)							\
	...
	DELEGATE0(void, Delegate0_VoidHandler);
	DELEGATE1(void, Delegate1_VoidHandler, int);

	void Test3(){
		// 第三步：使用宏，实现 多播委托，也是UE4委托的做法？
		cout << endl;
		cout << "第三步：使用宏" << endl;
		Delegate0_VoidHandler<void> Void_Handler0(HandleVoidFunc0);
		Void_Handler0.Invoke();
		cout << endl;
		Delegate1_VoidHandler<void> Void_Handler1(HandleVoidFunc);
		Void_Handler1.Invoke(100);
		cout << endl;
		A a4;
		Delegate1_VoidHandler<A> A_Handler1(&a4, &A::Func);
		A_Handler1.Invoke(800);
